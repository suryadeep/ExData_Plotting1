...
plot(dates,vlt,type="l",xlab="datetime",ylab="Voltage")

plot(dates,sm1,type="l",xlab="",ylab="Energy sub metering")
lines(dates,sm2,type="l",col="Red")
lines(dates,sm3,type="l",col="blue")
legend("topright", col=c("black", "red", "blue"), c("Sub_Metering_1","Sub_Metering_2","Sub_Metering_3"),lty=1,bty = "n",lwd=2.5)

plot(dates,grp,type="l",xlab="datetime",ylab="Global Reactive Power")
